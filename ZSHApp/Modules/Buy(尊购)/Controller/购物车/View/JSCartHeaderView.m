...
- (void)setHeaderUI{
    ...
    [self.selectStoreGoodsButton setImage:[UIImage imageNamed:@"goods_choose_normal"]
                             forState:UIControlStateNormal];
    [self.selectStoreGoodsButton setImage:[UIImage imageNamed:@"goods_choose_press"]
...
//    [self.selectStoreGoodsButton addTarget:self action:@selector(selectShopGoods:) forControlEvents:UIControlEventTouchUpInside];
    ...
    self.storeNameButton.titleLabel.font = kPingFangLight(16);
...
- (void)layoutSubviews{
    ...
    self.storeNameButton.frame = CGRectMake(40, 0, KScreenWidth-40, 30);
