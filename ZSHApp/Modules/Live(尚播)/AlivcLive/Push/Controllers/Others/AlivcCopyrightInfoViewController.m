...
- (void)setupSubViews {
    ...
    contentLabel.frame = CGRectMake(0, 0, KScreenWidth, CGRectGetHeight(scrollView.frame));
    ...
    scrollView.contentSize = CGSizeMake(KScreenWidth, contentLabel.frame.size.height + 50);
