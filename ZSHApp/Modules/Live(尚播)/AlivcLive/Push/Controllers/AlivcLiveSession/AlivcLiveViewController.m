...
- (void)setupDebugView {
    ...
    self.textView = [[UITextView alloc] initWithFrame:CGRectMake(20, 60, kRealValue(200), kRealValue(350))];
    if (_isScreenHorizontal) {
        self.textView.frame = CGRectMake(20, 60, kRealValue(470), kRealValue(100));
    }
