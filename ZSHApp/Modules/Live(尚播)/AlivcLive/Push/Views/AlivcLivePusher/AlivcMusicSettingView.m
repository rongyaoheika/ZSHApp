...
- (void)setupSubviews {
    ...
    self.lineView.backgroundColor = KZSHColorRGB(141, 141, 141);
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    if (selected) {
        self.nameLabel.textColor = KZSHColorRGB(0, 192, 251);
...
- (void)setupSubViews {
    ...
    self.backgroundColor = KZSHColorRGB(74, 74, 74);
...
- (void)setupMusicVolumeView {
    ...
    volumeView.frame = CGRectMake(0,
                                  ...
                                  self.frame.size.height-kRealValue(44));
    [self addSubview:volumeView];
    
    int labelCount = 2;
    CGFloat retract = 10;

    CGFloat labelWidth = kRealValue(30);
    if (KScreenWidth > KScreenHeight) {
        retract = 6;
        labelWidth = kRealValue(30);
    }
    ...
    for (int index = 0; index < labelCount; index++) {
        ...
        slider.frame = CGRectMake(CGRectGetMaxX(nameLabel.frame) + retract,
                                  ...
                                  CGRectGetWidth(volumeView.frame)-kRealValue(110),
                                  labelWidth);
...
- (void)setupBottomView {
    ...
    CGFloat viewWidth = kRealValue(50);
