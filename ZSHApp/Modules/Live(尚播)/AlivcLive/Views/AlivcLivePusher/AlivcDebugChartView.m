...
#define kAlivcChartViewRetractX kRealValue(20)
#define kAlivcChartViewRetractY (kRealValue(5) + kAlivcChartViewRetractX)
#define kAlivcChartModuleHeight kRealValue(150)
