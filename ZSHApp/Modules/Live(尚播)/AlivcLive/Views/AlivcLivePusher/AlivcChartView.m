...
- (void)setupBackground {
    ...
    self.backgroundLayer.frame = CGRectMake(CGRectGetMaxX(self.textLabel.frame) + 5, 0, kRealValue(180), CGRectGetHeight(self.frame));
...
- (void)setupProgress {
    ...
    self.barLayer.frame = CGRectMake(CGRectGetMaxX(self.textLabel.frame) + 5, 0, kRealValue(180), CGRectGetHeight(self.frame));;
...
- (void)setupBarTitle {
    ...
    self.titleLabel.frame = CGRectMake(0, 0, kRealValue(75), CGRectGetHeight(self.frame));
...
- (void)setupBarText {
    ...
    self.textLabel.frame = CGRectMake(CGRectGetMaxX(self.titleLabel.frame), 0, kRealValue(30), CGRectGetHeight(self.frame));
